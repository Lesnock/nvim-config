...
vim.keymap.set({ 'n' }, 'tt', ':ToggleTerm direction=float<CR>', { desc = 'Open terminal' })
vim.keymap.set({ 'n' }, '<C-t>', '<cmd>lua create_terminal()<CR>', { desc = 'Create terminal' })
vim.keymap.set({ 't' }, '<Esc>', '<C-\\><C-n>:ToggleTermToggleAll<CR>', { desc = 'Closes terminal' })
